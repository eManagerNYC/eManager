...
{
	?>
	<h2><?php echo apply_filters( self::PREFIX . '/dashboard_instructions/title', 'Use the menus on the left to add and edit website content.' ); ?></h2>
	...
	<?php /** /<p><?php echo apply_filters( self::PREFIX . '/dashboard_instructions/content', 'If you need help, please read the instructions below.' ); ?></p>
