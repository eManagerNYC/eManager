 ...
 */
(function() {
    tinymce.PluginManager.add('eman_magic_button', function( editor, url ) {
        editor.addButton( 'eman_magic_button', {
...
(function() {
    tinymce.PluginManager.add('eman_no_wrap', function( editor, url ) {
            editor.addButton( 'eman_no_wrap', {
            title: 'No-Wrap',
			icon: 'nonbreaking',
            onclick: function() {
