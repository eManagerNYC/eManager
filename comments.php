 ...
 */
function eman_comment( $comment, $args, $depth )
{
	...
	<div id="comment-<?php comment_ID(); ?>" <?php comment_class('cf'); ?>>
		<article  class="cf">
			<header class="comment-author vcard">
				...
				<?php /** / ?><time datetime="<?php echo comment_time('Y-m-j'); ?>"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>"><?php comment_time( 'F jS, Y' ); ?> </a></time><?php /**/ ?>
				<cite class="fn"><span class="author"><?php echo get_comment_author_link(); ?></span>, <?php comment_time( 'F jS, Y' ); ?></cite>
			</header>
...
<section class="comments cf">
	...
	<?php if ( have_comments() ) : ?>
		...
		<h3 id="comments-title"><?php comments_number( '<span>No</span> Comments', '<span>1</span> Comment', '<span>%</span> Comments' );?></h3>
