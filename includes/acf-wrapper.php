...
function eman_get_field( $field_key, $post_id=false, $format_value=true )
{
...
function eman_the_field( $field_key, $post_id=false )
{
	...
	$output = eman_get_field($field_key, $post_id);
	if ( is_array($value) ) {
