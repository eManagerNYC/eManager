...
Version:      0.2.1
Author:       Seebz
Author URI: https://github.com/Seebz/Snippets/blob/master/Wordpress/plugins/purge-transients/purge-transients.php
*/
if (! function_exists('purge_transients') )
{
	function purge_transients( $older_than='7 days', $safemode=true )
	{
		...
		if ( $older_than_time > time() || $older_than_time < 1 ) { return false; }
