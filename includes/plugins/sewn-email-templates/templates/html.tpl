...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <title><?php if (! empty($subject) ) { echo $subject; } ?></title>
        <style type="text/css">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;background-color: #F4F4F4;border-top: 1px solid #FFFFFF;border-bottom: 1px solid #CCCCCC;border-collapse: collapse !important;">
                                        <tr>
                                            <td valign="top" class="headerContent" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;color: #505050;font-family: Helvetica;font-size: 20px;font-weight: bold;line-height: 100%;padding-top: 0;padding-right: 0;padding-bottom: 0;padding-left: 0;text-align: left;vertical-align: middle;">
                                            	<img src="<?php echo $header_image; ?>" alt="<?php if (! empty($header_image_alt) ) { echo $header_image_alt; } ?>" style="max-width: 600px;-ms-interpolation-mode: bicubic;border: 0;height: auto;line-height: 100%;outline: none;text-decoration: none;" id="headerImage" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- // END HEADER -->
                        	...
                        	<tr>
                            	<td align="center" valign="top" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;background-color: #F4F4F4;border-top: 1px solid #FFFFFF;border-collapse: collapse !important;">
                                        <?php if ( $twitter_url || $facebook_url || $linkedin_url || $googleplus_url ) : ?>
                                        <tr>
                                            <td valign="top" class="footerContent" mc:edit="footer_content00" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;color: #808080;font-family: Helvetica;font-size: 10px;line-height: 150%;padding-top: 20px;padding-right: 20px;padding-bottom: 20px;padding-left: 20px;text-align: left;">
                                                <?php if ( $twitter_url ) : ?><a href="<?php echo $twitter_url; ?>" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;color: #606060;font-weight: normal;text-decoration: underline;"><?php echo $twitter_text; ?></a>&nbsp;<?php endif; ?><?php if ( $facebook_url ) : ?>&nbsp;&nbsp;<a href="<?php echo $facebook_url; ?>" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;color: #606060;font-weight: normal;text-decoration: underline;"><?php echo $facebook_text; ?></a>&nbsp;<?php endif; ?><?php if ( $linkedin_url ) : ?>&nbsp;&nbsp;<a href="<?php echo $linkedin_url; ?>" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;color: #606060;font-weight: normal;text-decoration: underline;"><?php echo $linkedin_text; ?></a>&nbsp;<?php endif; ?><?php if ( $googleplus_url ) : ?>&nbsp;&nbsp;<a href="<?php echo $googleplus_url; ?>" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;color: #606060;font-weight: normal;text-decoration: underline;"><?php echo $googleplus_text; ?></a>&nbsp;<?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php endif; ?>
                                        <tr>
                                            <td valign="top" class="footerContent" style="padding-top: 20px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;color: #808080;font-family: Helvetica;font-size: 10px;line-height: 150%;padding-right: 20px;padding-bottom: 20px;padding-left: 20px;text-align: left;" mc:edit="footer_content01">
                                                <em>Copyright &copy; <?php echo $year; ?> <?php echo get_option('blogname'); ?>, All rights reserved.</em>
                                                <br />
                                                <?php if ( $address ) : ?>
                                                <br />
                                                <br />
                                        ...
                                        <?php if ( $unsubscribe_url || $profile_url ) : ?>
                                        <tr>
                                            <td valign="top" class="footerContent" style="padding-top: 20px;padding-bottom: 40px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;color: #808080;font-family: Helvetica;font-size: 10px;line-height: 150%;padding-right: 20px;padding-left: 20px;text-align: left;" mc:edit="footer_content02">
                                            	<?php if ( $unsubscribe_url ) : ?><a href="<?php echo $unsubscribe_url; ?>" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;color: #606060;font-weight: normal;text-decoration: underline;"><?php echo $unsubscribe_text; ?></a>&nbsp;<?php endif; ?><?php if ( $profile_url ) : ?>&nbsp;&nbsp;<a href="<?php echo $profile_url; ?>" style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;color: #606060;font-weight: normal;text-decoration: underline;"><?php echo $profile_text; ?></a>&nbsp;<?php endif; ?>
                                            </td>
                                        </tr>
                                        <?php endif; ?>
                                    </table>
