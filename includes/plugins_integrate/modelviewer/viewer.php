...
function modelscripts() {
  /*Register*/
  wp_enqueue_script('Detector', get_template_directory_uri(). '/includes/plugins/modelviewer/assets/Detector.js', false);
  wp_enqueue_script('Three', get_template_directory_uri(). '/includes/plugins/modelviewer/assets/three.min.js', false);
  wp_enqueue_script('TrackballControls', get_template_directory_uri(). '/includes/plugins/modelviewer/assets/TrackballControls.js', false);
  wp_enqueue_script('Stats', get_template_directory_uri(). '/includes/plugins/modelviewer/assets/stats.min.js', false);
  wp_enqueue_script('jama-materials', get_template_directory_uri(). '/includes/plugins/modelviewer/assets/jama-materials.js', false);
  wp_enqueue_script('jama-materials-data', get_template_directory_uri(). '/includes/plugins/modelviewer/assets/jama-materials-data.js', false);
}
...
function ModelViewer( $atts ) {
  ...
  extract( shortcode_atts( array(
    'url' => get_template_directory_uri().'/includes/plugins/modelviewer/assets/rac_basic_sample_project.rvt.js',
    'loc' => 'New York',
    'width' => '800',
    'height' => '600'
  ), $atts, 'model' ) );
  ...
  /*
  echo '<script type="text/javascript" src='.get_template_directory_uri(). '/includes/plugins/modelviewer/assets/Detector.js></script>';
  echo '<script type="text/javascript" src='.get_template_directory_uri(). '/includes/plugins/modelviewer/assets/three.min.js></script>';
  echo '<script type="text/javascript" src='.get_template_directory_uri(). '/includes/plugins/modelviewer/assets/TrackballControls.js></script>';
  echo '<script type="text/javascript" src='.get_template_directory_uri(). '/includes/plugins/modelviewer/assets/stats.min.js></script>';
  echo '<script type="text/javascript" src='.get_template_directory_uri(). '/includes/plugins/modelviewer/assets/jama-materials.js></script>';
  echo '<script type="text/javascript" src='.get_template_directory_uri(). '/includes/plugins/modelviewer/assets/jama-materials-data.js></script>';
  */
